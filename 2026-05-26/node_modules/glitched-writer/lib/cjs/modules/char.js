...
class Char {
    ...
    writeToElement() {
        ...
        charEl && utils_1.animateWithClass(charEl, 'gw-changed');
    }
    set spanElement(el) {
        if (!this.els)
            return;
    ...
    type() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const loop = () => __awaiter(this, void 0, void 0, function* () {
                yield utils_1.wait(options.getInterval(this));
            ...
            yield utils_1.wait(options.getDelay(this));
            yield utils_1.promiseWhile(() => (!this.finished || options.endless) &&
                !state.isPaused &&
                !this.stop, loop);
            if (this.finished) {
                state.progress.increase();
    ...
    addGhost() {
        ...
        utils_1.coinFlip() ? insertGhost(ghosts[0], l) : insertGhost(ghosts[1], l);
    }
    removeGhost() {
        const { writer, ghosts } = this, deleted = utils_1.coinFlip() && ghosts[0].length > 0
            ? utils_1.deleteRandom(ghosts[0])
            : utils_1.deleteRandom(ghosts[1]);
        if (deleted)
            writer.state.nGhosts--;
    }
}
